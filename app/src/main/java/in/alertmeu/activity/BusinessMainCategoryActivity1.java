...
public class BusinessMainCategoryActivity1 extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    ...
                    Intent intent = new Intent(BusinessMainCategoryActivity1.this, HomePageActivity.class);
                    startActivity(intent);
                    finish();
                } else {
       ...
       //     mProgressDialog.setIndeterminate(false);
        ...
        protected void onPostExecute(Void args) {
           // mProgressDialog.dismiss();
            if (data.size() > 0) {
                mainCatListAdpter = new MainCatListAdpter(BusinessMainCategoryActivity1.this, data);
                mainCatList.setAdapter(mainCatListAdpter);
                mainCatList.setLayoutManager(new LinearLayoutManager(BusinessMainCategoryActivity1.this));
