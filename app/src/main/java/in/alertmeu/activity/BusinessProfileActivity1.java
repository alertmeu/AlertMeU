...
public class BusinessProfileActivity1 extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
        ...
        calling.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (preferences.getString("account_status", "").equals("1")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(BusinessProfileActivity1.this);
                            ...
                            .setPositiveButton(res.getString(R.string.logreg)
                                    , new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            dialog.cancel();
                                            Intent intent = new Intent(BusinessProfileActivity1.this, RegisterNGetStartActivity.class);
                    ...
                    if (askForPermission(Manifest.permission.CALL_PHONE, CALL)) {
                        ...
                        if (ActivityCompat.checkSelfPermission(BusinessProfileActivity1.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//emailIntent.putExtra(Intent.EXTRA_HTML_TEXT, body); //If you are using HTML in your body text
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (preferences.getString("account_status", "").equals("1")) {
                    ...
                    Intent intent1 = new Intent(BusinessProfileActivity1.this, FullScreenViewActivity.class);
        ...
        writeReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (preferences.getString("account_status", "").equals("1")) {
                    ...
                    final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(BusinessProfileActivity1.this);
        ...
        torcountr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BusinessProfileActivity1.this, ShowAllReviewsActivity.class);
        ...
        pricelist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BusinessProfileActivity1.this, DisplayMenuActivity.class);
                intent.putExtra("business_id", id);
                intent.putExtra("title", title);
                startActivity(intent);
            }
        ...
        if (AppStatus.getInstance(BusinessProfileActivity1.this).isOnline()) {
            synchronized (this) {
                getImagePath();
            ...
            Toast.makeText(BusinessProfileActivity1.this, res.getString(R.string.jpcnc), Toast.LENGTH_SHORT).show();
        }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private class initRatingUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(BusinessProfileActivity1.this);
            ...
            if (updateStatusResponse.compareTo("") != 0) {
                if (isJSONValid(updateStatusResponse)) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(BusinessProfileActivity1.this, res.getString(R.string.jpcnc), Toast.LENGTH_LONG).show();
                        }
                    });
    ...
    private class getAdvertisement extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            ...
            if (advertisementDAOList.size() > 0) {
                ...
                advertisementListAdpter = new ActiveAdvertisementListAdpter(BusinessProfileActivity1.this, advertisementDAOList);
               ...
               // recyclerView.setLayoutManager(new LinearLayoutManager(BusinessProfileActivity.this));
                recyclerView.setLayoutManager(new LinearLayoutManager(BusinessProfileActivity1.this, LinearLayoutManager.HORIZONTAL, false));
            } else {
    ...
    private class getOthBusiness extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            ...
            if (data.size() > 0) {
                hideothbusiness.setVisibility(View.VISIBLE);
                otherBusinessListAdpter = new OtherBusinessListAdpter(BusinessProfileActivity1.this, data);
                othBuinessList.setAdapter(otherBusinessListAdpter);
                othBuinessList.setLayoutManager(new LinearLayoutManager(BusinessProfileActivity1.this));
            } else {
                hideothbusiness.setVisibility(View.GONE);
    ...
    private class initInappropriateUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            // mProgressDialog.dismiss();
            if (status) {
                Toast.makeText(BusinessProfileActivity1.this, res.getString(R.string.jdus), Toast.LENGTH_LONG).show();
            } else {
                // Toast.makeText(BusinessProfileActivity.this, msg, Toast.LENGTH_LONG).show();
...
//                        // shouldShowRequestPermissionRationale will return true
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        if (ContextCompat.checkSelfPermission(BusinessProfileActivity1.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(BusinessProfileActivity1.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(BusinessProfileActivity1.this, new String[]{permission}, requestCode);
