...
public class ViewImageDescriptionActivity1 extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        synchronized (this) {
            if (AppStatus.getInstance(ViewImageDescriptionActivity1.this).isOnline()) {
                synchronized (this) {
                    insertUserClick();
                    getImagePath();
                ...
                Toast.makeText(ViewImageDescriptionActivity1.this, res.getString(R.string.jpcnc), Toast.LENGTH_SHORT).show();
            }
        ...
        calling.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (preferences.getString("account_status", "").equals("1")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ViewImageDescriptionActivity1.this);
                            ...
                            .setPositiveButton(res.getString(R.string.logreg)
                                    , new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            dialog.cancel();
                                            Intent intent = new Intent(ViewImageDescriptionActivity1.this, RegisterNGetStartActivity.class);
                    ...
                    if (askForPermission(Manifest.permission.CALL_PHONE, CALL)) {
                        ...
                        if (ActivityCompat.checkSelfPermission(ViewImageDescriptionActivity1.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//emailIntent.putExtra(Intent.EXTRA_HTML_TEXT, body); //If you are using HTML in your body text
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (preferences.getString("account_status", "").equals("1")) {
                    ...
                    Intent intent1 = new Intent(ViewImageDescriptionActivity1.this, FullScreenViewActivity.class);
        ...
        takebarCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utility.showLoadingDialogQr(ViewImageDescriptionActivity1.this);
        ...
        readmore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ViewImageDescriptionActivity1.this, BusinessProfileActivity.class);
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
            ...
            if (updateStatusResponse.compareTo("") != 0) {
                if (isJSONValid(updateStatusResponse)) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ViewImageDescriptionActivity1.this, "Please check your network connection", Toast.LENGTH_LONG).show();
                        }
                    });
    ...
    private class initRatingUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            mProgressDialog = new ProgressDialog(ViewImageDescriptionActivity1.this);
            // Set progressdialog title
            ...
            if (updateStatusResponse.compareTo("") != 0) {
                if (isJSONValid(updateStatusResponse)) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ViewImageDescriptionActivity1.this, res.getString(R.string.jpcnc), Toast.LENGTH_LONG).show();
                        }
                    });
        ...
        switch (id) {
            case R.id.inappropriate:
                ...
                if (preferences.getString("account_status", "").equals("1")) {
                    ...
                    final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewImageDescriptionActivity1.this);
    ...
    private class initInappropriateUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            // mProgressDialog.dismiss();
            if (status) {
                Toast.makeText(ViewImageDescriptionActivity1.this, res.getString(R.string.jdus), Toast.LENGTH_LONG).show();
            } else {
    ...
    private class getAdvertisement extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            advertisementListResponse = serviceAccess.SendHttpPost(Config.URL_GETALLCURRENTACTADSOTHCATBUSINESSID, jsonLeadObj1);
        ...
        protected void onPostExecute(Void args) {
            ...
            if (advertisementDAOList.size() > 0) {
                ...
                advertisementListAdpter = new ActiveAdvertisementListAdpter(ViewImageDescriptionActivity1.this, advertisementDAOList);
                recyclerView.setAdapter(advertisementListAdpter);
                recyclerView.setLayoutManager(new LinearLayoutManager(ViewImageDescriptionActivity1.this));
            } else {
...
//                        // shouldShowRequestPermissionRationale will return true
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        if (ContextCompat.checkSelfPermission(ViewImageDescriptionActivity1.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(ViewImageDescriptionActivity1.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(ViewImageDescriptionActivity1.this, new String[]{permission}, requestCode);
