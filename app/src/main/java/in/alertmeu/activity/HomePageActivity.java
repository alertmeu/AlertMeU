            ...
            public void onClick(View view) {
                if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                    if (checkLocation()) //check whether location service is enable or not in your  phone
                    {
                        ...
                        prefEditor.commit();
                        Intent intent = new Intent(HomePageActivity.this, IncidentReportActivity.class);
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 3) {
                    if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                        if (checkLocation()) //check whether location service is enable or not in your  phone
                        {
                            Intent intent = new Intent(getApplicationContext(), IncidentReportActivity.class);
                            startActivity(intent);
                        }
        ...
        try {
            ...
            if (!preferences.getString("npsdate", "").equals("null")) {
                ...
                try {
                    ...
                    d2 = format.parse(preferences.getString("npsdate", ""));
                } catch (ParseException e) {
                    e.printStackTrace();
                }

                if (d1.compareTo(d2) >= 0) {
                    Intent intent = new Intent(HomePageActivity.this, NetPromotorScoreActivity.class);
