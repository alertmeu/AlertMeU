...
public class LogoutActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LogoutActivity.this, UserProfileSettingActivity.class);
    ...
    private class initLogOutUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (status) {
                ...
                prefEditor.remove("account_status");
                prefEditor.remove("app_login");
                ...
                prefEditor.remove("npsdate");
                prefEditor.remove("syncc");
                prefEditor.remove("notifyonoffads");
                prefEditor.remove("notifyonoffevent");
                prefEditor.remove("notifyonoffinc");
                prefEditor.remove("units_for_area");
                prefEditor.remove("notifyonoffinfo");
                prefEditor.commit();
