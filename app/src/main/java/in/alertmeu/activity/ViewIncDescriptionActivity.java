...
public class ViewIncDescriptionActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res = getResources();
        intent = getIntent();
        setContentView(R.layout.activity_view_inc_description);
        ...
        incidentList = (RecyclerView) findViewById(R.id.advertisementList);
        ...
        calling.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAndRequestPermissions()) {
                    ...
                    if (ActivityCompat.checkSelfPermission(ViewIncDescriptionActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//emailIntent.putExtra(Intent.EXTRA_HTML_TEXT, body); //If you are using HTML in your body text
                ...
                if (checkAndRequestPermissions()) {
                    if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                        ...
                        if (bmpUri != null) {
                            ...
                            shareIntent.putExtra(Intent.EXTRA_TEXT, "Incident reported on AlertMeU (http://www.alertmeu.com), a platform to find everything at your location. Download app at (https://play.google.com/store/apps/details?id=in.alertmeu).\n\n" + imgDes + " \n" + mobile_no);
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (preferences.getString("account_status", "").equals("1")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ViewIncDescriptionActivity.this);
                    builder.setMessage(res.getString(R.string.jprqr))
                            ...
                            .setPositiveButton(res.getString(R.string.logreg), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    dialog.cancel();
                                    Intent intent = new Intent(ViewIncDescriptionActivity.this, RegisterNGetStartActivity.class);
                    ...
                    Intent intent1 = new Intent(ViewIncDescriptionActivity.this, FullScreenViewActivity.class);
        ...
        refute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (preferences.getString("account_status", "").equals("1")) {
                    ...
                    if (AppStatus.getInstance(getApplicationContext()).isOnline()) {
                        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewIncDescriptionActivity.this);
        ...
        addinfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (preferences.getString("account_status", "").equals("1")) {
                    ...
                    Intent intent = new Intent(ViewIncDescriptionActivity.this, IncidentMoreInfoReportActivity.class);
        ...
        if (AppStatus.getInstance(ViewIncDescriptionActivity.this).isOnline()) {
            synchronized (this) {
                getImagePath();
            ...
            Toast.makeText(ViewIncDescriptionActivity.this, res.getString(R.string.jpcnc), Toast.LENGTH_SHORT).show();
        }
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(ViewIncDescriptionActivity.this);

        incidentListAdpter = new IncidentListAdpterPage(ViewIncDescriptionActivity.this, new ArrayList<>());
        incidentList.setLayoutManager(layoutManager);
        //incidentList.setLayoutManager(new LinearLayoutManager(ViewIncDescriptionActivity.this, LinearLayoutManager.HORIZONTAL, false));
            ...
            if (updateStatusResponse.compareTo("") != 0) {
                if (isJSONValid(updateStatusResponse)) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ViewIncDescriptionActivity.this, res.getString(R.string.jpcnc), Toast.LENGTH_LONG).show();
                        }
                    });
...
//                        // shouldShowRequestPermissionRationale will return true
    ...
    public void onBackPressed() {
        ...
        if (preferences.getString("incback", "").equals("1")) {
            Intent setIntent = new Intent(ViewIncDescriptionActivity.this, HomePageActivity.class);
            startActivity(setIntent);
            finish();
        } else {
           // Intent setIntent = new Intent(ViewIncDescriptionActivity.this, IncidentReportListActivity.class);
    ...
    private class getMoreOtherInc extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            ...
            if (data.size() > 0) {
                ...
                incidentMoreInfoListAdpter = new IncidentMoreInfoListAdpter(ViewIncDescriptionActivity.this, data);
                othBuinessList.setAdapter(incidentMoreInfoListAdpter);
                // othBuinessList.setLayoutManager(new LinearLayoutManager(ViewIncDescriptionActivity.this));
                othBuinessList.setLayoutManager(new LinearLayoutManager(ViewIncDescriptionActivity.this, LinearLayoutManager.HORIZONTAL, false));
            } else {
    ...
    private class getAdvertisement extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            advertisementListResponse = serviceAccess.SendHttpPost(Config.URL_GETALLOTHERINCADSBYIDPAGE, jsonLeadObj1);
        ...
        protected void onPostExecute(Void args) {
           ...
           /* if (advertisementDAOList.size() > 0) {
                ...
                incidentListAdpter = new IncidentListAdpter(ViewIncDescriptionActivity.this, advertisementDAOList);
                recyclerView.setAdapter(incidentListAdpter);
                recyclerView.setLayoutManager(new LinearLayoutManager(ViewIncDescriptionActivity.this));
            } else {
            ...
            if (advertisementDAOList.size() > 0) {
                ...
                incidentListAdpter.addItems(advertisementDAOList);
    ...
    private class initInappropriateUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            // mProgressDialog.dismiss();
            if (status) {
                Toast.makeText(ViewIncDescriptionActivity.this, res.getString(R.string.jdus), Toast.LENGTH_LONG).show();
            } else {
                // Toast.makeText(ViewIncDescriptionActivity.this, msg, Toast.LENGTH_LONG).show();
            ...
            if (updateStatusResponse.compareTo("") != 0) {
                if (isJSONValid(updateStatusResponse)) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ViewIncDescriptionActivity.this, "Please check your network connection", Toast.LENGTH_LONG).show();
                        }
                    });
