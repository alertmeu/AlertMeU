...
public class IncidentDAO {
    ...
    public IncidentDAO(String id, String user_id, String description, String describe_limitations, String latitude, String longitude, String create_at, String flag_map, String path, String rq_code, String title, String mobile_no, String address, String likecnt, String dislikecnt, String business_name, String s_date, String e_date, String s_time, String e_time, String numbers, boolean isSelected) {
        this.id = id;
    ...
    public String getpBidavgrating() {
        return pBidavgrating;
    }

    public void setpBidavgrating(String pBidavgrating) {
        this.pBidavgrating = pBidavgrating;
    }

    public String getTorcount() {
        return torcount;
    }

    public void setTorcount(String torcount) {
        this.torcount = torcount;
    }
