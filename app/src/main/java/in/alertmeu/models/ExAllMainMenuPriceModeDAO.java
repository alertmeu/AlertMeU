...
public class ExAllMainMenuPriceModeDAO {
    private String id;
    ...
    public ExAllMainMenuPriceModeDAO() {
    }

    public ExAllMainMenuPriceModeDAO(String id, String title, String description, String rate, String link, String image_path, String subbc_id, String maincat_id, String business_user_id, String mainid_pricelist) {
        this.id = id;
        this.title = title;
