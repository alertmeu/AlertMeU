...
public class UserSubIncidentTypeListAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UserSubIncidentTypeListAdpter(Context context, List<IncidentSubTypeModeDAO> data) {
