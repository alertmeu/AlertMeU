...
public class AllOtherBusinessListAdpterPage extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public AllOtherBusinessListAdpterPage(Context context, List<LocationDAO> postItems) {
